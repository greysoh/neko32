...
#ruledef
{
    ...
    bit_not   {registerFirst: register} {registerSecond: register} {registerOutput: register} => 0x0e @registerFirst @registerSecond @registerOutput
    ...
    math_dec {registerFirst: register} {registerSecond: register} {registerOutput: register} => 0x13 @registerFirst @registerSecond @registerOutput
